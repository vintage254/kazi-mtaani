          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="#about" className="text-gray-300 hover:text-white transition-colors">About Program</a>
                </li>
                <li>
                ...
                <li>
                  <Link href="/sign-up" className="text-gray-300 hover:text-white transition-colors">Get Started</Link>
                </li>
              </ul>
            </div>
