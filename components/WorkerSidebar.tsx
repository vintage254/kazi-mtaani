...
export default function WorkerSidebar({ worker, notifications = 0 }: WorkerSidebarProps) {
  ...
  return (
    <div className={`sidebar-fixed inset-y-0 left-0 bg-white border-r border-gray-200 transition-all duration-300 overflow-y-auto ${
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex justify-between">
                  <span>Group:</span>
                  <span className="font-medium text-gray-900">{worker.group}</span>
                </div>
                <div className="flex justify-between">
                  <span>Supervisor:</span>
                  <span className="font-medium text-gray-900">{worker.supervisor}</span>
                </div>
                <div className="flex justify-between">
                  <span>Status:</span>
