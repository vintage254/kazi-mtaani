          ...
          <div className="bg-white rounded-lg shadow-sm border">
            ...
            <div className="p-6">
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-700">Westlands Cleanup Site</p>
                <p className="text-xs text-blue-600 mt-1">Westlands, Nairobi</p>
              </div>
            </div>
          </div>
